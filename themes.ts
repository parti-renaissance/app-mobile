...
const lightColors = {
  ...
  ...addSetOfTransparenciesToColor(colorTokens.light.pink.pink5, 'pink', true),
  ...colorTokens.light.pink,
  ...addSetOfTransparenciesToColor(colorTokens.light.purple.purple5, 'purple', true),
  ...colorTokens.light.purple,
  ...addSetOfTransparenciesToColor(colorTokens.light.red.red5, 'red', true),
...
export const templates = (() => {
  ...
  const buttonContainedSurface = {
    background: transparencies + 6,
    backgroundHover: transparencies + 7,
    backgroundPress: transparencies + 8,
    color: white.white1,
  ...
  const buttonOutlinedSurface = {
    ...
    backgroundPress: transparencies + 3,
    borderColor: transparencies + 6,
    borderColorHover: transparencies + 7,
    borderColorPress: transparencies + 7,
