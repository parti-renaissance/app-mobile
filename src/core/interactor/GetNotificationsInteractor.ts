...
export class GetNotificationsInteractor {
  ...
  public async execute(category: NotificationCategory): Promise<GetNotificationsInteractorResult> {
    ...
    if (state === AuthenticationState.Authenticated) {
      ...
      const pushEnabled = await this.pushRepository.arePushNotificationsEnabled(category);
      return {
