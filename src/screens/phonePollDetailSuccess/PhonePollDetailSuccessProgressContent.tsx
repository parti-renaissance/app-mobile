...
export const PhonePollDetailSuccessProgressContent: FunctionComponent<Props> = ({ viewModel }) => {
  ...
  return (
    <>
      ...
      <ProgressBar progress={viewModel.progress / viewModel.total} color={Colors.accent} />
    </>
  );
};
