...
const HomeScreen: FunctionComponent<HomeScreenProps> = ({ navigation }) => {
  ...
  const renderSectionHeader = (info: {
    ...
    return <SectionHeader title={viewModel.sectionName} isHighlighted={viewModel?.isHighlighted} />;
  };
  ...
  const renderItem = ({
    ...
    if (item.type === "region") {
      return <HomeRegion viewModel={item.value} onMorePressed={onRegionMorePressed} />;
      ...
      return <HomeFeedEventRow viewModel={item.value} onEventSelected={onFeedEventSelected} />;
    } else if (item.type === "feedNews") {
      return <HomeFeedNewsRow viewModel={item.value} onNewsSelected={onFeedNewsSelected} />;
      ...
      return <HomeFeedPollRow viewModel={item.value} onPollSelected={onFeedPollSelected} />;
