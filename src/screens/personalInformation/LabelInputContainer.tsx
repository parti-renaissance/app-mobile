...
const LabelInputContainer: FC<Props> = (props) => {
  ...
  const borderColor = hasErrorMessage ? Colors.inputTextErrorMessage : Colors.separator;
  const labelStyle = props.labelStyle ? props.labelStyle : styles.label;
  const labelStateStyle = props.disabled === true ? styles.labelDisabled : styles.labelEnabled;
  ...
  return (
    <View>
      <View style={[containerStyle]}>
        ...
        <View style={[styles.input, props.multiLine ? styles.inputMultiLine : null]}>
          {props.children}
        </View>
      </View>
