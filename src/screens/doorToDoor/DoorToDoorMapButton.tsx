  ...
  <CardView borderRadius={30} backgroundColor={Colors.defaultBackground} style={style}>
    <TouchablePlatform onPress={onPress} touchHighlight={Colors.touchHighlight} disabled={disabled}>
      <View style={styles.content}>
        <Image style={[styles.mapButtonIcon, disabled ? styles.imageDisabled : null]} source={image} />
        {text !== undefined && <Text style={[styles.mapButtonText, disabled ? styles.disabled : null]}>{text}</Text>}
        {disabled && <Spinner />}
      </View>
    </TouchablePlatform>
  </CardView>
