...
const PollDetailQuestionInputContent: FunctionComponent<PollDetailQuestionInputContentProps> = ({
  ...
  const inputAccessoryViewId = "PollDetailQuestionInputAccessoryViewId" + viewModel.id;
  const inputRef = useRef<TextInput>(null);
  const [remaingCharsLabel, setRemainingCharsLabel] = useState(computeRemainingCharsLabel(""));
