...
const PhoningSessionLoaderScreen: FunctionComponent<PhoningSessionLoaderScreenProps> = ({
  ...
  const [statefulState, setStatefulState] = useState<ViewState<void>>(ViewState.Loading());

  useEffect(() => {
    const handleSession = (session: PhoningSession, adherent: PhoningSessionAdherent) => {
