...
const EventDetailsScreen: FC<EventDetailsScreenProps> = ({ route }) => {
  const { statefulState, onReloadEvent } = useEventDetailsScreen(route.params.eventId);
    ...
    <SafeAreaView style={styles.container} forceInset={{ top: "never" }}>
      <StatefulView
        ...
        contentComponent={(detailedEvent) => {
          return (
            <EventDetailsContent detailedEvent={detailedEvent} onReloadEvent={onReloadEvent} />
          );
        }}
      />
    </SafeAreaView>
