...
const consentSection = (data: UserConsentData): PollDetailQuestionUserDataSectionViewModel => {
  return {
    id: "consent",
    ...
    data: [
      {
        ...
        value: {
          ...
          highlightedSuffix: i18n.t("polldetail.user_form.consent_subtitle_suffix"),
        },
      },
      {
        type: "dualChoice",
...
const formSection = (data: UserConsentData): PollDetailQuestionUserDataSectionViewModel => {
  return {
    id: "form",
...
export const PollDetailQuestionUserDataViewModelMapper = {
  map: (data: UserConsentData): PollDetailQuestionUserDataViewModel => {
    var sections: Array<PollDetailQuestionUserDataSectionViewModel> = [consentSection(data)];
