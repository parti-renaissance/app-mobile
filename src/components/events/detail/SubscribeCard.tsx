    ...
    <YStack justifyContent="center" gap="$4.5">
      <YStack gap="$3" alignItems="center">
        ...
        <Text fontWeight="$6" fontSize="$1" color="$textSecondary">
          Créer un compte pour participer à cet événement.
        </Text>
      </YStack>
...
export function LockAuthAdhCard() {
  return (
    <YStack justifyContent="center" gap="$4.5">
      <YStack gap="$3" alignItems="center">
        <Unlock size="$3" rotate="-15deg" color="$textSecondary" />
        <Text fontWeight="$6" fontSize="$1" color="$textSecondary">
          Cet événement est réservé aux adhérents.
        </Text>
      </YStack>
...
export function LockAdhDueCard() {
  return (
    <YStack justifyContent="center" gap="$4.5">
      <YStack gap="$3" alignItems="center">
        <Unlock size="$3" rotate="-15deg" color="$textSecondary" />
