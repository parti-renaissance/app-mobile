...
import { FlatList, type FlatList as RNScrollView } from 'react-native'
import { composeRefs } from '@tamagui/compose-refs'
import type { GetRef } from '@tamagui/core'
import type { ScrollViewProps } from '@tamagui/scroll-view'
import { ScrollView } from '@tamagui/scroll-view'
import { useSheetContext } from '@tamagui/sheet/src/SheetContext'
import type { SheetScopedProps } from '@tamagui/sheet/src/types'
...
export const FlatListView = forwardRef<GetRef<typeof ScrollView>, ScrollViewProps>(
  ({ __scopeSheet, children, onScroll, ...props }: SheetScopedProps<ScrollViewProps>, ref) => {
